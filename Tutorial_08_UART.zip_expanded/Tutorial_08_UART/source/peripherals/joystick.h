...
/**
 * @brief Update current joystick state with given interrupt flags
 * @param interrupt_flags Interrupt flags, interrupts which happend
 */
...
/**
 * @brief check if joystick has been pressed and clear given button state
 * @param joystick_button one of the possible joystick inputs
 * @return true if joystick input has been pressed
 */
