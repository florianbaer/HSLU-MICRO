...
- pin_list:
  ...
  - {pin_num: '54', peripheral: GPIOB, signal: 'GPIO, 1', pin_signal: ADC0_SE9/ADC1_SE9/PTB1/I2C0_SDA/FTM1_CH1/FTM1_QD_PHB, direction: INPUT, gpio_interrupt: kPORT_InterruptFallingEdge,
    slew_rate: slow, pull_select: up, pull_enable: enable}
...
void Joystick(void)
{
    ...
    PORT_SetPinInterruptConfig(JOYSTICK_JS_RIGHT_PORT, JOYSTICK_JS_RIGHT_PIN, kPORT_InterruptFallingEdge);
    ...
    PORT_SetPinInterruptConfig(JOYSTICK_JS_DOWN_PORT, JOYSTICK_JS_DOWN_PIN, kPORT_InterruptFallingEdge);
    ...
    PORT_SetPinInterruptConfig(JOYSTICK_JS_UP_PORT, JOYSTICK_JS_UP_PIN, kPORT_InterruptFallingEdge);
    ...
    PORT_SetPinInterruptConfig(JOYSTICK_JS_PUSH_PORT, JOYSTICK_JS_PUSH_PIN, kPORT_InterruptFallingEdge);
    ...
    PORT_SetPinInterruptConfig(JOYSTICK_JS_LEFT_PORT, JOYSTICK_JS_LEFT_PIN, kPORT_InterruptFallingEdge);
