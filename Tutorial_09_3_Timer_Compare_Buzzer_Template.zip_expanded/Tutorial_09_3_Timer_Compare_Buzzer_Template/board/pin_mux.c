...
- {pin_num: '35', pin_signal: PTA1/UART0_RX/FTM0_CH6/JTAG_TDI/EZP_DI, label: UART0_RX, identifier: UART0_RX;BOARD_UART0_RX}
- {pin_num: '36', pin_signal: PTA2/UART0_TX/FTM0_CH7/JTAG_TDO/TRACE_SWO/EZP_DO, label: UART0_TX, identifier: UART0_TX;BOARD_UART0_TX}
...
- pin_list:
  ...
  - {pin_num: '36', peripheral: UART0, signal: TX, pin_signal: PTA2/UART0_TX/FTM0_CH7/JTAG_TDO/TRACE_SWO/EZP_DO, direction: OUTPUT, open_drain: enable}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_UART(void)
{
    ...
    PORT_SetPinMux(BOARD_UART_BOARD_UART0_RX_PORT, BOARD_UART_BOARD_UART0_RX_PIN, kPORT_MuxAlt2);
